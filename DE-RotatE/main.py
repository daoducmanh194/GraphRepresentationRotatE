...
parser.add_argument('-model', help='Model', type=str, default='DE_DistMult', choices = ['DE_DistMult', 'DE_TransE', 'DE_SimplE', 'DE_RotatE', 'DE_ComplEx'])
parser.add_argument('-ne', help='Number of epochs', type=int, default=100, choices = [500])

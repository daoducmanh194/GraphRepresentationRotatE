...
class Trainer:
    def __init__(self, dataset, params, model_name):
        ...
        #self.model = torch.load('/content/gdrive/My Drive/KBC/DE-Original/models/DE_RotatE/icews05-15/200_512_0.001_0.0_68_500_0.2_32_20_0.68_160.chkpnt')
        #self.model.train()
